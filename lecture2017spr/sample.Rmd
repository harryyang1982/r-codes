...
16-17. 아래의 그래프와 같은 모양이 나오도록 함께 첨부한 **seoul_dust.csv** 데이터를 활용하여 서울의 미세먼지 정도를 측정할 수 있는 두 개의 그래프를 그리는 ggplot 코드를 각각 작성하시오. (각 10점. seoul_dust.csv는 seoul 데이터 프레임에 저장할 것.)
